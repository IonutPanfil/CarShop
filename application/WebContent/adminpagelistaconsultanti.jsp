...
table, th, td {
    ...
    width:100%;
      ...
      <title>Lista consultanti - administrator</title>
   ...
   <body>
      <div class="wrapper">
         ...
         <center>
         <% List<Conturi> conturi = Interogari.getAllConturiByTip("consultant"); %>
	...
	<%for (Conturi c : conturi) {%>
        <tr>
         ...
         <center><br><br>
         <h1 style="color:white;">Schimba consultant in client:</h1>
         <form action="SwitchToClient" method="post">
         	<input name="idcont" type="text" placeholder="ID Cont">
         	<input class="submit-client" type="submit" value="Schimba"></input>
         </form>
         
         
         <br><br><h1 style="color:white;">Raports:</h1>
         <% List<Consultant> consultanti = ConsultantManager.getAllRaports();%>
         <table style="width: 70%; background-color: aqua;">
	<tr>
            <th style="text-align: left">ID</th>
            <th style="text-align: left">ID Consultant</th>
            <th style="text-align: left">Consultant</th>
            <th style="text-align: left">Raport</th>
        </tr>
	<%for (Consultant c1 : consultanti) {%>
        <tr>
            <td style="align-content: center"><%=c1.getId()%></td> 
            <td style="align-content: center"><%=c1.getIdConsultant()%></td>
            <td style="align-content: center"><%=c1.getNumeConsultant()%></td>
            <td style="align-content: center"><%=c1.getRaport()%></td>
        </tr>
         <% } %>
     </table>
